...
Below is an example of what the player and the code editor look like for
the Pong game.
If you look at the code editor, you can see that you can select the
language with the dropdown on the top-right.
The Run button on the top-left allows you to inject the code into the game,
and see the agent come to life! Note that it's important that you select the correct
language for the code you are writing in order for it to work.
...
Now that you are more familiar with the code editor, head to the [JavaScript][javascript]
section to learn more on how to write agents in JavaScript.

Don't like coding in JavaScript?
Don't worry, MoroboxAI also has support for [Lua][lua]!
